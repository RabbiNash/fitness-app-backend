...
const addexerciseRepository = (exerciseOptions) => __awaiter(void 0, void 0, void 0, function* () {
    let exercise = yield exercise_model_1.default.create(Object.assign(Object.assign({}, exerciseOptions), { Id: (0, uuid_1.v4)() }));
    return exercise;
});
...
const getexerciseRepository = (Id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let exerciseFound = yield exercise_model_1.default.findByPk(Id);
...
const getAllworkoutCategoriesRepository = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let workoutCategoriessFound = yield exercise_model_1.default.findAll();
...
const upDateexerciseRepository = (updateOptions) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let exercisesFound = yield exercise_model_1.default.update(Object.assign({}, updateOptions), {
            where: {
                Id: updateOptions.Id
            }
        });
...
const deleteexerciseRepository = (Id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        //return the number of destroyed rows
        let deletedexercise = yield exercise_model_1.default.destroy({
            where: {
                Id: Id
            }
        });
